...
contract reward is  IERC20 , Proxyable {
    ...
    function name() public view returns (string memory) {
        ...
        return IERC20(address(this)).name();
    }

    function symbol() public view returns (string memory) {
        // Immutable static call from target contract
        return IERC20(address(this)).symbol();
    }

    function decimals() public view returns (uint8) {
        // Immutable static call from target contract
        return IERC20(address(this)).decimals();
    }
    ...
    function approve(address spender, uint256 value) public returns (bool) {
        ...
        // Forward the ERC20 call to the target contract
        IERC20(address(this)).approve(spender, value);
    ...
    function transferFrom(
        ...
        // Forward the ERC20 call to the target contract
        IERC20(address(this)).transferFrom(from, to, value);
